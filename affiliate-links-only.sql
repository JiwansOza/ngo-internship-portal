-- =====================================================
-- AFFILIATE LINKS FEATURE - ADDITIONS ONLY
...
-- =====================================================
-- 7. CREATE AFFILIATE LINKS FOR EXISTING USERS
-- =====================================================
...
SELECT 'affiliate_links' as table_name, COUNT(*) as record_count FROM public.affiliate_links
UNION ALL
SELECT 'donations' as table_name, COUNT(*) as record_count FROM public.donations;

-- Check if functions were created
SELECT routine_name 
FROM information_schema.routines 
WHERE routine_schema = 'public' 
AND routine_name IN ('generate_link_code', 'create_default_affiliate_link', 'update_fundraising_on_donation')
...
AND trigger_name IN ('on_user_affiliate_link_created', 'on_donation_completed')
ORDER BY trigger_name;

-- =====================================================
-- AFFILIATE LINKS FEATURE ADDED SUCCESSFULLY!
-- =====================================================
...
-- ✅ Functions for link generation and progress updates
-- ✅ Triggers for automatic operations
-- ✅ Indexes for performance
-- ✅ Affiliate links created for existing users

-- Test the feature:
-- 1. Visit /affiliate in your app
-- 2. Share the generated link
-- 3. Test donations via /donate/:linkCode 